...
\title{A Search for New Physics in Fully Leptonic Final States of Top Quark Pair Production Using Simulation-Based Inference and Standard Model Effective Field Theory}   % Title

\author{Christopher McGrady}
\work{Dissertation}
...
\include{accelerator_and_detector/accelerator_and_detector}
\include{data_and_mc/data_and_mc}
\include{object_reconstruction/object_reconstruction}
\include{event_selection/event_selection}
\include{data_to_mc_corrections/data_to_mc_corrections}
\include{systematics/systematics}
\include{statistical_methods/statistical_methods}
